...
with DAG(
    ...
    task1_script_path = '/opt/airflow/dags/bom_dag/py_callables/task_1.py'
    task_1 = BashOperator(
    ...
    task2_script_path = '/opt/airflow/dags/bom_dag/py_callables/task_2.py'
    task_2 = BashOperator(
    ...
    task3_script_path = '/opt/airflow/dags/bom_dag/py_callables/task_3.py'
    task_3 = BashOperator(
    ...
    task4_script_path = '/opt/airflow/dags/bom_dag/py_callables/task_4.py'
    task_4 = BashOperator(
    ...
    task5_script_path = '/opt/airflow/dags/bom_dag/py_callables/task_5.py'
    task_5 = BashOperator(
