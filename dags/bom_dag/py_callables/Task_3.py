...
try:
    with open('/opt/airflow/utils/callable_snowql/task_3/create_replace_bom_cleaned_table.snowql', 'r') as sql_file:
...
try:
    with open('/opt/airflow/utils/callable_snowql/task_3/transform_upsert_into_bom_cleaned.snowql', 'r') as sql_file:
